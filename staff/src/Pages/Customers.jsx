...
import DataTable from "./Enquiries/NewTable";
...
export default function Customers() {
    const columns = [
      ...
      { accessor: "pincode", Header: "Pin code" },
    ...
    const data = [
      {
        id: '<span class="bg-soft-success custom-avatar rounded-full h-auto ">T</span>',
        name: `<a className='!text-[#687cfe] !font-bold customerNameLink' href='${"/edit-customer/256"}'>Sandeep</a>`,
        phone: "9048897361",
        message: "testing",
        city: "banglore",
        state: "karnataka",
        pincode: "560066",
        address: "4th main block, kasthuri nagar",
        createdat: "04/01/2024",
        action: "completed",
      },
      {
        id: '<span class="bg-soft-success custom-avatar rounded-circle">T</span>',
        name: `<p className='!text-[#687cfe]'><a className='!text-[#687cfe]' href='${"/edit-customer/256"}'>Sandeep</a></p>`,
        phone: "9048897361",
        message: "testing",
        city: "banglore",
        state: "karnataka",
      ...
      {
        id: '<span class="bg-soft-success custom-avatar rounded-circle">T</span>',
        name: `<p className='!text-[#687cfe]'><a href='${"/edit-customer/256"}'>Sandeep</a></p>`,
        phone: "9048897361",
        message: "testing",
        city: "banglore",
        state: "karnataka",
                ...
                <div className="col-lg-12">
                  <div className="card">
                    ...
                    <div className="card-body !border-none">
                                          <DataTable columns={columns} data={data} type={"customers"} />
                    </div>
                    {/* <!-- end card-body --> */}
                  </div>
                  {/* <!--end card--> */}
