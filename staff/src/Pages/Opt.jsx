    ...
    <>
      ...
      <div className="auth-page-wrapper pt-5">
        ...
        <div className="auth-one-bg-position auth-one-bg">
          <div
            id="light"
            className="fixed top-0 h-[450px] w-full !overflow-hidden  z-[-1]"
          ></div>
                    ...
                    <div className="p-2 fadeIn third">
                      <form onSubmit={handleSubmit}>
                        <div className=" w-full mx-auto ">
                          ...
                          />
                          {otpError && (
                            <p className="text-[#fb3048] font-normal text-center w-full !text-xs !px-3 flex items-center justify-center my-2 gap-1">
                              <svg
                                data-v-059cda41=""
                                data-v-4b5d7b40=""
                                viewBox="0 0 24 24"
