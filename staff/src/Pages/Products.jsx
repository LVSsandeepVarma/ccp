        ...
        <div className="main-content">
          <div className="page-content">
            <div className="container-fluid">
                ...
                <div className="col-lg-5">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-muted mb-2 fs-15">
                      Choose your plan according to your busibess needs
                    </p>
                      ...
                      <div className="card pricing-box">
                        <div className="card-body bg-light m-2 p-3">
                          <div className="d-flex align-items-center mb-3 flex-wrap">
                            ...
                            <div className="">
                              <h2 className="month mb-0 h2">
                                ₹900{" "}
                                <small className="fs-13 text-muted">
                                  /Month
                                </small>
                              </h2>
                              <h2 className="quarter mb-0 d-none h2">
                                {" "}
                                ₹2,500{" "}
                                <small className="fs-13 text-muted">
                                  /3 Months
                              ...
                              <h2 className="half mb-0 d-none h2">
                                {" "}
                                ₹4,999{" "}
                                <small className="fs-13 text-muted">
                                  /6 Months
                            ...
                            <li>
                              <div className="text-center plan-btn mt-2">
                                <a
                                  ...
                                  className="btn btn-primary bg-primary btn-sm w-sm waves-effect waves-light action-btn btn-signup"
                                >
                                  Sign up
                                </a>
                              </div>
                              <div className="text-center plan-btn mt-2 hidden-buttons">
                                <a
                                  href="javascript:void(0);"
                                ...
                                <a
                                  href="javascript:void(0);"
                                  className="btn btn-success bg-success btn-sm w-sm waves-effect waves-light"
                                  data-bs-toggle="modal"
                        ...
                        <div className="card-body bg-light m-2 p-3">
                          <div className="d-flex align-items-center mb-3 flex-wrap">
                            ...
                            <div className="">
                              ...
                              <h2 className="annual mb-0 d-none h2">
                                ₹21,000{" "}
                                <small className="fs-13 text-muted">
                                  /Year
                                </small>
              ...
              <div className="row justify-content-center mt-4" id="toll-number">
                <div className="col-lg-5">
                  <div className="text-center mb-4">
                        ...
                        <div className="card-body bg-light m-2 p-3">
                          <div className="d-flex align-items-center mb-3 flex-wrap">
                            ...
                            <div className="">
                              ...
                              <h2 className="toll-quarter mb-0 d-none h2">
                                {" "}
                                ₹4,299{" "}
                                <small className="fs-13 text-muted">
                                  /3 Months
                              ...
                              <h2 className="toll-half mb-0 d-none h2">
                                {" "}
                                ₹7,999{" "}
                                <small className="fs-13 text-muted">
                                  /6 Months
                              ...
                              <h2 className="toll-annual mb-0 d-none h2">
                                ₹18,000{" "}
                                <small className="fs-13 text-muted">
                                  /Year
                                </small>
                      ...
                      <div className="card pricing-box">
                        <div className="card-body p-4 m-2">
                          <div>
                            <div className="d-flex align-items-center">
                              <div className="flex-grow-1">
                                <h5 className="mb-1 fw-semibold h5">EXTENDED</h5>
                                <p className="text-muted mb-0">Per License</p>
                              </div>
                              <div className="avatar-sm">
                                <div className="avatar-title bg-light rounded-circle text-primary">
