...
export default function Comments({type, logData, onHide}) {
  ...
  useEffect(() => {
    ...
    const { data: commentsLogs, isLoading: loading, error: logError } = useCommentLogsQuery({id:logData?.id, position: type?.toUpperCase().split(" ").join("")});
        ...
        <div className="col-lg-6 border-end">
          ...
          <Modal.Body className="modal-body">
            ...
            >
              ...
              <input
                className="hidden"
                value={type?.toUpperCase().split(" ").join("")}
                {...register("source")}
              />
              <div className="mb-3">
