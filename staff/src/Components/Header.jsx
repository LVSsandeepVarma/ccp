               ...
               <div className="navbar-header">
                  <div className="d-flex">
                     ...
                     <div className="navbar-brand-box horizontal-logo">
                        ...
                        <img src="assets/images/ccp_logo.webp" width="160px" alt=""/>
                        </span>
                     ...
                     <form className="app-search d-none d-md-block">
                        ...
                        <div className="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                           <div data-simplebar className="max-h-[320px]">
                              {/* <!--  item--> */}
                  ...
                  <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                           ...
                           <div className="tab-content position-relative" id="notificationItemsTabContent">
                              <div className="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                 <div data-simplebar  className="pe-2 max-h-[300px]">
                                       ...
                                       <div className="d-flex">
                                          ...
                                          <div className="flex-1">
                                             ...
                                             <div className="fs-13 text-muted">
                                                <p className="mb-1">Answered to your comment on the cash flow forecast&lsquo;s
                                                   graph 🔔.
                                                </p>
                                             </div>
                                             <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                     ...
                     <div className="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <div className="dropdown-menu dropdown-menu-end">
                           ...
                           <a className="dropdown-item" href="profile.html"><i className="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span className="align-middle">Profile</span></a>
                           ...
                           <a className="dropdown-item" href="profile.html"><i className="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span className="align-middle">Balance : <b>$5971.67</b></span></a>
                           ...
                           <a className="dropdown-item" href="index.html"><i className="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span className="align-middle" data-key="t-logout">Logout</span></a>
                        </div>
                     </div>
                  </div>
               </div>
